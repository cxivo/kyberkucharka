export default function Substitutions() {
  return (
    <div className="recipe">
      <div className="about">
        <title>Ako nahrádzať ingrediencie</title>
        <div className="recipe-title">
          <h1>Ako nahrádzať ingrediencie</h1>
        </div>

        <div className="recipe-body recipe-text">
          <p>
            Niekedy má človek alergiu na niektoré suroviny v recepte, niekedy ich neje kvôli svojej diéte a niekedy dané suroviny jednoducho nemá. To 
            by však nemalo brániť človeku predsa len si nejakú dobrotu upiecť. Na tejto stránke uvediem niektoré užitočné náhrady, všetky sa sem veru nepomestia.
            Nezabúdajte, že niektoré z týchto surovín sú fakt základné a väčšina z ich náhrad je zložitejšia na zohnanie, alebo minimálne drahšia.
          </p>
          <p>
            Ani táto stránka nebude pravdepodobne nikdy hotová, budem sem postupne
            pridávať nové tipy a zistenia ako sa ich budem učiť.
          </p>
          <h2>Vajíčka</h2>
          <p>Najčastejšie nahrádzaná surovina - nejakým spôsobom sa vždy rýchlo minú a do obchodu nie vždy skočiť ide. Vegáni možno tiež tieto substitúcie ocenia:</p>
          <ul>
            <li><em>Banány</em> - najčastejšia substitúcia v sladkých receptoch, kde vajíčko používame na účel zlepovača, najlepšie však v múčnikoch a pudingoch. Miesto jedného vajca
            potrebujete asi pol až celý banán, ideálne prezretý. Pozor - výsledok bude chutiť extrémne banánovo, nie každému to ide po chuti.</li>
            <li><em>Jablkové pyré</em> - aneb <em>detská výživa</em>, je omnoho trvácnejšia surovina než vajíčka či banány. Jedno vajce nahradíme 5 lyžicami pyré zmiešaných s jednou lyžičkou prášku do pečiva. 
          ...
          <p>
            ...
            miesto krupice hrubú. Dajte ale pozor, že menšie zrnitosti sa môžu viac hrudkovať a mať krémovejší výsledok.
          </p>
          <h2>Mlieko</h2>
          <p>Popravde, tu je voľba najľahšia - siahnite po rastlinnom mlieku, napríklad sójovom. Dajte len pozor, či nie je ochutené.</p>
          <p>Keby však chcete nahrádzať mlieko kvôli tomu, že žiadne nemáte, môžete zmiešať vodu s maslom alebo smotanou - takto dosiahnete aspoň rovnaký objem a približne
            správny podiel tukov.
          </p>
